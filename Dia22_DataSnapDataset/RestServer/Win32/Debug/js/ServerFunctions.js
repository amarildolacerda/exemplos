...
function TServerMethods1(connectionInfo)
{
  ...
  this.GetCliente_URL = function(codigo) {
    return this.executor.getMethodURL("GetCliente", "GET", [codigo], arguments[1])[0];
  };
   ...
   */
  this.GetCliente2 = function(codigo) {
    var returnObject = this.executor.executeMethod('GetCliente2', "GET", [codigo], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetCliente2_URL = function(codigo) {
    return this.executor.getMethodURL("GetCliente2", "GET", [codigo], arguments[1])[0];
  };
   ...
   * @return result - Type on server: TFDJSONDataSets
   */
  this.GetNotaFiscal = function(ANumero) {
    var returnObject = this.executor.executeMethod('GetNotaFiscal', "GET", [ANumero], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.ANumero = ANumero;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
